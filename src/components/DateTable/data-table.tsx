...
import {activeFetchData,callDeleteTask} from '../../api'
...
export function DataTable<TData, TValue>({
    ...
    state: {
      ...
      /*Define functions here 
			get fn in columns by table.options?.meta.fnName */
  ...
  function onRefreshClick(){
	...
	function handleDeleteRow(id){
		id? callDeleteTask(id,onRefreshClick) : console.log('noID') 
	}
    ...
    <div className="bg-white px-5 pt-2 pb-2 shadow-default rounded-md border border-stroke">
      <div className="flex items-center py-4 justify-between">
        ...
        <NavLink
                to="/SelectScenarios"
                className={`inline-flex items-center justify-center rounded-md bg-meta-3 py-2 pl-2 pr-4 text-center font-medium text-white lg:px-4 xl:px-4 hover:bg-primary hover:bg-opacity-8`}
        >
        <svg 
